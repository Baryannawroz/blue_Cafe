...
<div class="row">
    <div class="col-sm-12">
        <div class="btn-group pull-right m-t-15">
            <a href="{{url('/all-expanse')}}" class="btn btn-default waves-effect">All Expense <span
                    class="m-l-5"></span></a>
        </div>
...
<div class="row">
    <div class="card-box">
        ...
        <form class="form-horizontal" role="form" method="post" id="expanseForm"
            action="/update-expanse/{{ $expanse->id }}" data-parsley-validate novalidate>
            {{csrf_field()}}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select name="reason_id" id="" class="form-control">
                        ...
                        <option value="{{ $reason->id }}" {{ $reason->id == $expanse->reason_id ? 'selected':'' }}>{{
                            $reason->name }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" value="{{$expanse->title}}" name="title" required class="form-control"
                        id="inputEmail3" placeholder="Cause of expanse">
                </div>
            </div>
            <div class="form-group">
                <label for="inputPassword3" class="col-sm-3 control-label">Date of Expanse :</label>
                <div class="col-sm-6">
                    <input type="text" value="{{\Carbon\Carbon::parse($expanse->date)->format('m/d/Y')}}" name="date"
                        required class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose">
                </div>
            </div>
            <div class="form-group">
