...
<?php $__env->startSection('content'); ?>
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="<?php echo e(url('/app-settings')); ?>">App Settings</a>
        </li>
    </ol>
    <div class="card-box">
        After setup your mail/pusher or app you must config your application cache. <a href="<?php echo e(url('/cache-config')); ?>">Click Hear</a> To config your application cache. After cache config you might need to re login
                        ...
                        <form class="form-horizontal" role="form" id="smtpMailSetting"  data-parsley-validate novalidate>
                            ...
                            <div id="smtpDetails">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input id="hori-pass1" type="url" data-parsley-pattern="/^\S*$/" name="host" placeholder="Host" value="<?php echo e(config('mail.host')); ?>" required parsley-type="url" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input  type="text" required data-parsley-pattern="/^\S*$/" name="port" placeholder="Port" value="<?php echo e(config('mail.port')); ?>" class="form-control" id="hori-pass2">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input  type="email" data-parsley-pattern="/^\S*$/" required name="mail_address" placeholder="Mail Address" value="<?php echo e(config('mail.username')); ?>" class="form-control" id="hori-pass2">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="hori-pass1" class="col-sm-2 control-label">Encryption <span class="text-danger">*</span></label>
                                    <div class="col-sm-7">
                                        <input id="" type="text" data-parsley-pattern="/^\S*$/" name="encryption" placeholder="Encryption [lave empty if encryption is null]" value="<?php echo e(config('mail.encryption')); ?>"  class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" data-parsley-pattern="/^\S*$/" required name="mail_form" placeholder="Mail Name" value="<?php echo e(config('mail.from.name')); ?>" class="form-control" id="hori-pass2">
                                    </div>
                                </div>
                            </div>
                        ...
                        <form class="form-horizontal" role="form" id="pusherSettings" method="post"  data-parsley-validate novalidate>
                            ...
                            <div id="smtpDetails">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" placeholder="App ID" name="app_id" value="<?php echo e(config('broadcasting.connections.pusher.app_id')); ?>" required  class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input  type="text" required placeholder="Key" name="key" value="<?php echo e(config('broadcasting.connections.pusher.key')); ?>" class="form-control" id="hori-pass2">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input  type="text" required placeholder="Pusher Secret" name="secret" value="<?php echo e(config('broadcasting.connections.pusher.secret')); ?>" class="form-control" id="hori-pass2">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input  type="text" required placeholder="cluster" name="cluster" value="<?php echo e(config('broadcasting.connections.pusher.options.cluster')); ?>" class="form-control" id="pass">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <form class="form-horizontal" role="form" id="timeZoneSettings"  data-parsley-validate novalidate>
                            ...
                            <div id="smtpDetails">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input id="" name="app_name" type="text" placeholder="Restaurant" value="<?php echo e(config('app.name')); ?>" required  class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div id="smtpDetails">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input id="" name="timezone" type="text" placeholder="TimeZone" value="<?php echo e(config('app.timezone')); ?>" required data-parsley-pattern="/^\S*$/" class="form-control">
                        ...
                        <form class="form-horizontal" role="form" id="currencySettings"  data-parsley-validate novalidate>
                            ...
                            <div id="smtpDetails">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input id="" name="symbol" type="text" placeholder="Symbol" value="<?php echo e(config('restaurant.currency.symbol')); ?>" required data-parsley-pattern="/^\S*$/" class="form-control">

                                    </div>
                                    <label for="hori-pass1" class="col-sm-2 control-label">Currency <span class="text-danger">*</span></label>
                                    <div class="col-sm-2">
                                        <input id="" name="currency" type="text" placeholder="Currency" value="<?php echo e(config('restaurant.currency.currency')); ?>" required data-parsley-pattern="/^\S*$/" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input id="" name="var_percentage" type="number" min="0" placeholder="Vat Percentage" value="<?php echo e(config('restaurant.vat.vat_percentage')); ?>" required data-parsley-pattern="/^\S*$/" class="form-control">

                                    </div>
                                    <label for="hori-pass1" class="col-sm-2 control-label">Vat Number <span class="text-danger">*</span></label>
                                    <div class="col-sm-4">
                                        <input id="" name="vat_number" type="text" placeholder="Vat Number" value="<?php echo e(config('restaurant.vat.vat_number')); ?>" required data-parsley-pattern="/^\S*$/" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input id="" name="phone" type="text" min="0" placeholder="Resturant Phone Number" value="<?php echo e(config('restaurant.contact.phone')); ?>" required  class="form-control">

                                    </div>
                                    <label for="hori-pass1" class="col-sm-2 control-label">Contact Address <span class="text-danger">*</span></label>
                                    <div class="col-sm-4">
                                        <input id="" name="address" type="text" placeholder="Resturant Address" value="<?php echo e(config('restaurant.contact.address')); ?>" required  class="form-control">
                                    </div>
                                </div>
...
<?php $__env->startSection('extra-js'); ?>
    <script src="<?php echo e(url('/app_js/SettingsController.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\blueCafe\resources\views/user/admin/app-setting.blade.php ENDPATH**/ ?>